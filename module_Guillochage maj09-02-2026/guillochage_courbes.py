...
class CourbesPanel:
    def __init__(self, parent, app_instance=None, on_change_callback=None, on_calque_modified_callback=None):
        ...
        # AJOUT LABEL 1 : TRAJECTOIRE
        tk.Label(self.group_def, text=self.t("z4_lbl_traj"), fg="#d4d4d4", bg="#252526", font=("Segoe UI", 8), anchor="w").pack(fill="x", padx=10, pady=(5, 0))
        ...
        self.combo_traj.pack(fill="x", padx=10, pady=(0, 5))
        
        # AJOUT LABEL 2 : ONDES
        tk.Label(self.group_def, text=self.t("z4_lbl_wave"), fg="#d4d4d4", bg="#252526", font=("Segoe UI", 8), anchor="w").pack(fill="x", padx=10, pady=(5, 0))
        ...
        self.combo_wave.pack(fill="x", padx=10, pady=(0, 5))
